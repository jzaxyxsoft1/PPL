...
var StorageSvc = exports.StorageSvc = {
        ...
        async.waterfall(
            [
                ...
                function (wcb) {
                    ...
                    Svc.insert('TranseferBill', transferBill, operator, function (e) {wcb(null);});
                },
                //单据条目赋值
                function (wcb) {
                    _.each(transferBill.Items, function (i) {
                            ...
                            function (pcb) {
                                async.each(transferBill.Items, function (i, ecb) {
                                    async.parallel(
                                        [
                                            function (ppcb) {
                                                async.each(i.Packages, function (pki, picb) {
                                                    Svc.db.Package.update({_id: pki }, {$set: { Route: order.Org}}, picb);
                                                }, ppcb);
                                            },
                                            function (ppcb) {
                                                StorageSvc.UpdateStorage(i.RelativeObj.Item1, operator.Org, (0 - i.Amount), (0 - i.Amount), ppcb);
                                            }
                                        ], ecb);
                                }, pcb);
                            }
    ...
    LockStorage: function (pid, amount, cb) {
        async.parallel(
            [
                function (pcb) {
                    StorageSvc.UpdateStorage(pid, Svc.OrgCache['0'], 0, amount, pcb);
                },
                function (pcb) {
                    StorageSvc.UpdateStorage(pid, Svc.OrgCache['1'], 0, amount, pcb);
                }
            ], cb)
    },
    /**
