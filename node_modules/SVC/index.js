...
var Svc = {
     ...
     */
    ICreator: {'StockIn': 1, 'StockOut': 1, 'TranseferBill': 1, 'Order': 1},
    /**
     * 实现创建时间接口的对象
     * interface ICreateTime:{CreateTime:{Item1:日期时间字符串,Item2:年(Number),Item3:月(Number),Item4:日(Number)}}
     */
    ICreateTime: {'StockIn': 1, 'StockOut': 1, 'TranseferBill': 1, 'Order': 1},
    /**
     * 部门对象接口的对象
     ...
     */
    IBill: {'Order': 1, 'StockIn': 1, 'StockOut': 1},
    /**
     * 更新审核对象
     ...
     * 单号前缀
     */
    BillNumPre: {'Order': 'ORD', 'Package': 'PKG', 'StockIn': 'ISTK', 'StockOut': 'OSTK', 'TranseferBill': 'TRB'},
    ErrorType: {
        '_未传递定义值参数': '未传递定义值参数!',
        '_无效的定义值': '无效的定义值!',
        '_未传递上级值参数': '未传递上级值参数!',
